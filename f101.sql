...
prompt  APPLICATION 101 - RCS 01
--
-- Application Export:
--   Application:     101
--   Name:            RCS 01
--   Date and Time:   22:32 Sunday May 14, 2023
--   Exported By:     RCS
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,4774300428028209));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'RCS'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'RCS 01'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F101'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 4799206911084966 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 4799418067084966 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 4802502023084967 + wwv_flow_api.g_id_offset,
  p_error_template=> 4798805943084966 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20230514223137',
  ...
  p_cust_authentication_process=> '.'||to_char(4808119616084973 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 21,
  p_default_label_template => 4806800523084969 + wwv_flow_api.g_id_offset,
  p_default_report_template => 4806108837084969 + wwv_flow_api.g_id_offset,
  p_default_list_template => 4805117932084968 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 4807103942084970 + wwv_flow_api.g_id_offset,
  p_default_button_template => 4799916799084966 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 4801506412084967 + wwv_flow_api.g_id_offset,
  p_default_form_template => 4801604203084967 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 4803429763084968 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 4802502023084967 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>4802502023084967 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 4801001364084967 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 4801430946084967 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 4802114833084967 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'RCS',
  p_last_upd_yyyymmddhh24miss=> '20230514223137',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 4808402942084973 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 4816209600086683 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--application/shared_components/navigation/tabs/standard/t_demo_customers
wwv_flow_api.create_tab (
  p_id=> 4809826705085008 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_DEMO_CUSTOMERS',
  p_tab_text => 'Demo Customers',
  p_tab_step => 1,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_demo_orders
wwv_flow_api.create_tab (
  p_id=> 4814624074085014 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
  p_tab_name=> 'T_DEMO_ORDERS',
  p_tab_text => 'Demo Orders',
  p_tab_step => 2,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
...
wwv_flow_api.create_list_of_values (
  p_id       => 4813308988085013 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'Report Row Per Page',
  p_lov_query=> '.'||to_char(4813308988085013 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>4813429991085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4813519964085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4813612771085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4813703570085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4813824370085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4813902199085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4814018106085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4814103596085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4814203563085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>4814311746085013 + wwv_flow_api.g_id_offset,
  p_lov_id=>4813308988085013 + wwv_flow_api.g_id_offset,
...
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20230514223120'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 4809910258085009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'DEMO_CUSTOMERS',
  p_region_name=>'',
  p_plug_template=> 4801604203084967+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4813217384085013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 4801001364084967+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(4809517284084976 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 4807103942084970+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 4810011530085009 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
  p_button_sequence=> 10,
  p_button_plug_id => 4809910258085009+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(4799916799084966+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_button(
  p_id             => 4810217599085009 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
  ...
  p_button_condition=> 'P1_CUSTOMER_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 4810301654085009 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
...
wwv_flow_api.create_page_button(
  p_id             => 4810123473085009 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
...
wwv_flow_api.create_page_branch(
  p_id=>4810511869085010 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
...
wwv_flow_api.create_page_item(
  p_id=>4810601066085010 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  ...
  p_item_sequence=> 1,
  p_item_plug_id => 4809910258085009+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 4806800523084969+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'Y',
  p_item_comment => '');
...
wwv_flow_api.create_page_item(
  p_id=>4810700512085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CUST_FIRST_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
...
wwv_flow_api.create_page_item(
  p_id=>4810912193085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CUST_LAST_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 2,
...
wwv_flow_api.create_page_item(
  p_id=>4811110043085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CUST_STREET_ADDRESS1',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 3,
...
wwv_flow_api.create_page_item(
  p_id=>4811313851085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CUST_STREET_ADDRESS2',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 4,
...
wwv_flow_api.create_page_item(
  p_id=>4811516062085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CUST_CITY',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>4811716874085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CUST_STATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 6,
...
wwv_flow_api.create_page_item(
  p_id=>4811903633085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CUST_POSTAL_CODE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>4812118787085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_PHONE_NUMBER1',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 8,
...
wwv_flow_api.create_page_item(
  p_id=>4812313214085011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_PHONE_NUMBER2',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 9,
...
wwv_flow_api.create_page_item(
  p_id=>4812503576085012 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CREDIT_LIMIT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
...
wwv_flow_api.create_page_item(
  p_id=>4812701786085012 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_CUST_EMAIL',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 11,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:DEMO_CUSTOMERS:P1_CUSTOMER_ID:CUSTOMER_ID';

wwv_flow_api.create_page_process(
  p_id     => 4812901380085012 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 1,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:DEMO_CUSTOMERS:P1_CUSTOMER_ID:CUSTOMER_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 4813031456085012 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_process_sequence=> 1,
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'TS1'
 ,p_name => 'Demo Orders'
 ,p_step_title => 'Demo Orders'
 ,p_step_sub_title => 'Demo Orders'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20230514223121'
  );
null;
...
'"CUSTOMER_ID",'||chr(10)||
'"ORDER_TOTAL",'||chr(10)||
'"ORDER_TIMESTAMP",'||chr(10)||
'"USER_ID"'||chr(10)||
' from   "DEMO_ORDERS" '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 4814720837085014 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'DEMO_ORDERS',
  p_region_name=>'',
  p_plug_template=> 4802114833084967+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_worksheet(
  p_id=> 4814814361085014+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 4814720837085014+wwv_flow_api.g_id_offset,
  p_name=> 'DEMO_ORDERS',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
wwv_flow_api.create_worksheet_column(
  p_id => 4814921089085016+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4814814361085014+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4815023667085017+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4814814361085014+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4815111546085017+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4814814361085014+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4815213279085017+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4814814361085014+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ORDER_TIMESTAMP',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Order Timestamp',
  p_report_label           =>'Order Timestamp',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4815328214085017+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4814814361085014+wwv_flow_api.g_id_offset,
...
begin
rc1:=rc1||'ORDER_ID:CUSTOMER_ID:ORDER_TOTAL:ORDER_TIMESTAMP:USER_ID';

wwv_flow_api.create_worksheet_rpt(
  p_id => 4816416873088799+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4814814361085014+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4815532446085017 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 4798409846084965 + wwv_flow_api.g_id_offset
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4808723497084975 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4808822042084976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 4808723497084975+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>4808913556084976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>4809005939084976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(4799916799084966 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 4809224808084976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 4809120010084976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 4809402644084976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 4809301294084976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_menu (
  p_id=> 4809517284084976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>4813111763085012 + wwv_flow_api.g_id_offset,
  p_menu_id=>4809517284084976 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'Demo Customers',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>4815418386085017 + wwv_flow_api.g_id_offset,
  p_menu_id=>4809517284084976 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>20,
  p_short_name=>'Demo Orders',
  p_long_name=>'',
...
prompt  ......Page template 4798409846084965
...
wwv_flow_api.create_template(
  p_id=> 4798409846084965 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 4798507002084965
...
wwv_flow_api.create_template(
  p_id=> 4798507002084965 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4798609552084966
...
wwv_flow_api.create_template(
  p_id=> 4798609552084966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4798705684084966
...
wwv_flow_api.create_template(
  p_id=> 4798705684084966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4798805943084966
...
wwv_flow_api.create_template(
  p_id=> 4798805943084966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4798903826084966
...
wwv_flow_api.create_template(
  p_id=> 4798903826084966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4799026332084966
...
wwv_flow_api.create_template(
  p_id=> 4799026332084966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4799123723084966
...
wwv_flow_api.create_template(
  p_id=> 4799123723084966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4799206911084966
...
wwv_flow_api.create_template(
  p_id=> 4799206911084966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4799328312084966
...
wwv_flow_api.create_template(
  p_id=> 4799328312084966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template