...
import { GoCopilot, GoGoal } from "react-icons/go";
...
const Skeleton = () => {
  ...
  return (
    <div className="w-full h-full min-h-[4rem] overflow-hidden relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        ...
        <Container className="h-12 w-12 circle-4">
          <GoGoal className="h-6 w-6 dark:text-white" />
        </Container>
